    ...
    <div class="container">
        ...
        <nav class="top-menu">
            <ul class="sf-menu">
                ...
                <li><a href="#benefist" class="smooth-scroll"><?php L::W("BENEFITS"); ?></a></li>
                ...
                <li>
                    <a href="#"><?php L::W("POOLS"); ?></a>
                    <ul>
                        <li><a href="https://equipool.1ds.us/" target="_blank">1ds.us</a></li>
                        <li><a href="https://pool.btcz.site/" target="_blank">BitcoinZ Community Pool</a></li>
                        ...
                        <li><a href="https://bitcointalk.org/index.php?topic=2166510.0" target="_blank"><?php L::W("MORE_ON_THE_BITCOINTALK_FORUM"); ?></a></li>
                    </ul>
                </li>
                <li>
                ...
                <li>
                    ...
                    <ul>
                        ...
                        <li><a href="https://slack.bitcoinz.global/" target="_blank">Slack</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="buttons-section">
                                <a href="<?php L::W("COMMUNITY_PAPER_URL"); ?>" target="_blank" class="btn dark-btn large-btn"><?php L::W("COMMUNITY_PAPER"); ?></a><a href="https://youtu.be/RI-V7n8amFk" target="_blank" class="btn dark-btn large-btn"><?php L::W("START_MINING"); ?></a><a href="https://info.btcz.rocks/" class="btn dark-btn large-btn" target="_blank"><?php L::W("LATEST_NEWS"); ?></a><a href="https://btcz.fund/" class="btn dark-btn large-btn" target="_blank"><?php L::W("DONATE"); ?></a>

                                <div class="coinmarketcap-currency-widget" data-currency="bitcoinz" data-base="USD" data-secondary="" data-ticker="true" data-rank="true" data-marketcap="true"
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="tabs services-tabs">
                ...
                <div id="tabs-2">
                    <div class="col-md-6">
                        <div class="head-service small-head text-left">
                            ...
                            <p>
                                Sensitive data programs like wallets should provide free open source code and sha256 to their releases to be able to review their wallets by other teams / pods. It not
                                recommended to use any wallet which hasn't been reviewed by other team.
                            </p>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="link-full"><a href="https://bitcointalk.org/index.php?topic=2166510.0"><?php L::W("VIEW_FORUM"); ?><i aria-hidden="true" class="fa fa-angle-right"></i></a></div>
                </div>
            </div>
        </div>
    </div>
...
<section id="exchange" class="section-work-progress background-image bg-dark-section">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5">
                <a href="https://stocks.exchange/trade/BTCZ/BTC" target="_blank"><img src="<?php siteUrl(); ?>img/exchange-stocks-exchange.png" class="exch_img"></a>
            </div>
            <div class="col-md-4">
                <a href="https://tradesatoshi.com/Exchange?market=BTCZ_BTC" target="_blank"><img src="<?php siteUrl(); ?>img/2.png" class="exch_img"></a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-5 col-md-offset-3">
                <a href="https://c-cex.com/?p=btcz-btc" target="_blank"><img src="<?php siteUrl(); ?>img/4.png" class="exch_img"></a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="controls-portfolio center">
                    <a href="https://github.com/anthony19114/MyBitcoinZ/releases/tag/MyBitcoinZ-linux64-10.0.1"><img src="<?php siteUrl(); ?>img/lin.png" alt="Linux" title="Linux" class="wallets_img"></a><a href="https://play.google.com/store/apps/details?id=com.btczcom.btcz"><img src="<?php siteUrl(); ?>img/and.png" alt="Android" title="Android" class="wallets_img"></a><a href="https://github.com/anthony19114/MyBitcoinZ/releases/tag/MyBitcoinZ-osx-10.0.1"><img src="<?php siteUrl(); ?>img/os.png" alt="Mac OS" title="MacOS" class="wallets_img"></a><a href="https://github.com/bitcoinz-pod/bitcoinz-wallet/releases"><img src="<?php siteUrl(); ?>img/windows.jpg" alt="Windows" title="Windows" class="wallets_img"></a><a href="https://github.com/bitcoinz-pod/bitcoinz"><img src="<?php siteUrl(); ?>img/github.png" alt="github" title="Github" class="wallets_img"></a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-md-2">
                    <div class="item-carousel">
                        <a href="https://github.com/bitcoinz-pod/bitcoinz" target="_blank">
                            <img src="<?php siteUrl(); ?>img/partners-1.png" alt="logo">
                        </a>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="item-carousel">
                        <a href="https://bitcointalk.org/index.php?topic=2166510.0" target="_blank">
                            <img src="<?php siteUrl(); ?>img/partner2.png" alt="logo">
                        </a>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="item-carousel">
                        <a href="https://slack.bitcoinz.global/" target="_blank">
                            <img src="<?php siteUrl(); ?>img/partner3.png" alt="logo">
                        </a>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="item-carousel">
                        <a href="https://www.reddit.com/r/BTCZCommunity/" target="_blank">
                            <img src="<?php siteUrl(); ?>img/partner4.png" alt="logo">
                        </a>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="item-carousel">
                        <a href="https://discordapp.com/invite/u3dkbFs" target="_blank">
                            <img src="<?php siteUrl(); ?>img/disc.png" alt="logo">
                        </a>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="item-carousel">
                        <a href="https://www.facebook.com/BTCZCommunity/" target="_blank">
                            <img src="<?php siteUrl(); ?>img/face.png" alt="logo">
                        </a>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="item-carousel">
                        <a href="https://t.me/joinchat/CDzlaRGMvBm4P2Z76sNclQ" target="_blank">
                            <img src="<?php siteUrl(); ?>img/tel.png" alt="logo">
                        </a>
                    </div>
                </div>
                <div class="col-md-2">
                    <div class="item-carousel">
                        <a href="https://twitter.com/BitcoinZTeam" target="_blank">
                            <img src="<?php siteUrl(); ?>img/twit.png" alt="logo">
                        </a>
                    </div>
                </div>
            </div>
...
<script src="<?php siteUrl(); ?>js/api.js"></script>
<script src="<?php siteUrl(); ?>js/libs.js.pagespeed.ce.Av_NAtkm4V.js"></script>
<script src="<?php siteUrl(); ?>libs/style-customizer/style-customizer.js.pagespeed.ce.IgWtkWf8IC.js"></script>
<script src="<?php siteUrl(); ?>js/common.js.pagespeed.ce.hW1NRi6zyn.js"></script>
</body>
</html>
