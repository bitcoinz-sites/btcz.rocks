...
<ul class="sf-menu">
<!--Menu default-->
<li><a href="/media/Community_Paper_Final.pdf">COMMUNITY DOSSIER</a>
<li><a href="#benefist" class="smooth-scroll">VOORDELEN</a></li>
<li><a href="#exchange" class="smooth-scroll">KOPEN & VERKOPEN</a></li>
<li><a href="#wallets" class="smooth-scroll">WALLET</a></li>
<li><a href="#" class="smooth-scroll">Pools</a>
<ul>
<?php
include_once '../pools.php';
?>
<li><a href="https://bitcointalk.org/index.php?topic=2166510.0" target="_blank">En meer op de forum bitcointalk</a></li>
</ul></li>
...
<li><a href="#" class="smooth-scroll">SOCIALE MEDIA</a>
<ul>
<?php
...
<li class="menu-item-has-children current-menu-item"><a href="#" class="smooth-scroll">TAAL</a>
<ul class="sub-menu">
<?php
...
<li><a href="/media/Community_Paper_Final.pdf">COMMUNITY DOSSIER</a></li>
<li><a href="#benefist" class="smooth-scroll">VOORDELEN</a></li>
<li><a href="#exchange" class="smooth-scroll">KOPEN & VERKOPEN</a></li>
<li><a href="#wallets" class="smooth-scroll">WALLET</a></li>
...
?>
<li><a href="https://bitcointalk.org/index.php?topic=2166510.0" target="_blank">FORUM</a></li>
</ul></li>
...
<li class="menu-item-has-children current-menu-item"><a href="#" class="smooth-scroll">SOCIALE MEDIA</a>
<ul class="sub-menu"><br>
<?php
...
<div class="content">
<h3>BELANGRIJKE  <span>DETAILS</span></h3>
<p>-  Zorg dat je genoeg backups maakt van je wallet op verschillende locaties.<br>- Indien je grote aantallen munten hebt, sla ze dan op in offline wallets of hardware wallets met anonieme adressen.<br>- Geef nooit je private key aan iemand. De private key is de sleutel tot je munten en heb je nodig om toegang te krijgen tot je munten. Als je iemand je private key gegeven hebt, zorg dan dat je zo snel mogelijk je munten verhuisd naar een nieuwe wallet.</p>
...
<p>- Bitcoin technologie<br>- Anonieme transacties (zk-SNARKs privacy) – Bitcoin heeft bijvoorbeeld alle transacties publiekelijk.<br>- Gedecentraliseerde GPU mining (ASIC miners zijn verboden, hardforks om te voorkomen dat er ooit ASIC miners komen)<br>- Gedecentraliseerde ontwikkeling / Alle ontwikkelaars zijn vrijwilligers<br>- Grote blokken  Blokken zijn gelijkaardig aan BCC / BCH</p>
</div>
</div>
</div>
<div class="col-md-4">
...
<div class="content">
<h3>ACTIEVE <span>COMMUNITY</span></h3>
<p>Onze community is actief en we zijn steeds bezig met nieuwe ontwikkelingen.<br>Je kunt ons volgen op sociale netwerken, op het forum en op Slack.</p>
</div>
</div>
</div>
</div>
...
<h4>Maximaal beschikbaar aantal</h4>
...
<h2>Ons doel is om de best beschikbare software op de markt, <span>te kunnen gebruiken in Bitcoinz </span></h2>
<p>Onveranderbare parameters:</p>
</div>
<p>- Maximaal beschikbaar aantal </p>
<p>- Inflatie </p>
<p>- Enkel POW algoritme – We kunnen Equihash algoritme veranderen naar ander POW algoritme om ASIC miners tegen te houden</p>
<p>- Nieuwe ontwikkelingen zijn toegelaten voor het verbeteren en het schalen van het gebruik, maar we zullen nooit de geschiedenis van de munt veranderen (ETH/ETC voorbeeld)</p>
</div>
<div class="col-md-5 col-md-push-1">
<ul class="list">
<li>Algoritme: Equihash (altijd GPU mining – we promoten het decentraliseren van minen)</li>
<li>Maximaal aantal van 21 Miljard munten</li>
<li>Huidige aanvoer: 12500 munten iedere 2,5 minuut</li>
<li>Huidige blok grootte is gelijkaardig aan BCC/BCH (BTCZ = 2MB iedere 2,5 min ~ BCC/BCH = 8MB iedere 10 min)</li>
</ul>
</div>
</div>
<div id="tabs-2">
<div class="col-md-6">
<div class="head-service small-head text-left">
<h2>De meest beveiligde software is geïntegreerd in de <span>bitcoinz-pod/bitcoinz linux client</span></h2>
<p>Gevoelige data programma’s, zoals wallets, moeten gratis open-source code & sha256 beschikbaar stellen bij hun releases, zodat andere teams de wallet kunnen nakijken en verifiëren. Het is niet aanbevolen om een wallet te gebruiken die niet nagekeken is door een ander team!</p>
</div>
<p>Software die niet nagekeken is, moet gezien worden als een waarschuwing, en wordt aangeraden om niet te gebruiken.</p>
</div>
<!--<div class="col-md-5 col-md-push-1">
<ul class="list">
...
<h3>ANONIMITEIT</h3>
<p>Alle transacties zijn volledig anonym</p>
</div>
<!-- Item-->
<div class="col-md-3 col-sm-6 col-xs-12 item-icon">
<div class="icon-container">
...
<h3>ONDERSTEUNING VOOR ALLE PLATFORMEN</h3>
<p>Onze wallet is compatible met linux, windows, iOS en android. Daarnaast werken wij voortdurend aan verbeteringen</p>
</div>
<!-- Item-->
<div class="col-md-3 col-sm-6 col-xs-12 item-icon">
<div class="icon-container">
...
<h3>COMMUNITY</h3>
<p>We luisteren voortdurend naar onze community, zodat we kunnen slagen.</p>
</div>
<!-- Item-->
<div class="col-md-3 col-sm-6 col-xs-12 item-icon">
<div class="icon-container">
...
<h3>ACTIEVE PRIJSSTIJGING</h3>
<p>Bitcoinz is gefocust op organische groei.</p>
</div>
<!-- Edn items-->
</div>
</div>
...
<p>Koop of verkoop je Bitcoinz munten</p>
</div>
</div>
<?php
...
<div class="col-md-8 col-md-push-2">
<div class="heading-title center">
<h2>WAAROM VOOR <span>BitcoinZ KIEZEN</span></h2>
<div class="small-desd">HIER ZIJN ENKELE  <span> REDENEN</span></div>
<p>WAARSCHUWING! Denk altijd aan de valkuilen, en hou je backup keys in een veilige plaats!</p>
</div>
</div>
</div>
<div class="row">
...
<div class="content">
<h3>GEDECENTRALISEERDE MINING</h3>
<p>Indien je een miner bent, moet je niet de grootste pools gebruiken, dit om decentralisatie te stimuleren.<br>
Gemakkelijk te minen.<br>
Equihash algoritme.<br>
Gedecentraliseerde exchanges</p>
</div>
</div>
</div>
<!--Start item-->
...
<div class="content">
<h3>GEEN <span>PRE-MINE</span></h3>
<p>Pure munt! Geen pre-mine!</p>
</div>
</div>
</div>
<!--Start item-->
...
<div class="content">
<h3>BitcoinZ is  <span>Bitcoin 2.0:</span></h3>
<p>- 21 Miljard munten – Iedereen in de wereld kan tenminste 1 BTCZ bezitten</p>
</div>
</div>
</div>
</div>
...
<div class="content">
<h3>ACTIEVE <span>COMMUNITY</span></h3>
<p>Onze community is actief bezig met ontwikkelen en we groeien elke dag.	</p>
</div>
</div>
</div>
<!--Start item-->
...
<p>Alle transacties blijven anoniem. Op die manier hoef je je nooit zorgen te maken over anonimiteit.</p>
</div>
</div>
</div>
<!--Start item-->
...
<div class="content">
<h3>ANDROID & IOS  <span>WALLET</span></h3>
<p>Gebruik bitcoinz munten op je smartphone</p>
</div>
</div>
</div>
</div>
...
<div class="content">
<h3><span>NATUURLIJKE GROEI</span></h3>
<p>Je munt zal op een natuurlijke manier groeien en ontwikkelt worden</p>
</div>
</div>
</div>
<!--Start item-->
...
<div class="content">
<h3>GEDECENTRALISEERDE  <span>EXCHANGE</span></h3>
<p>Alle exchanges zijn toegelaten. De beste zijn gedecentraliseerd. We zijn van plan om volledig gedecentraliseerde XCAT exchange te implementeren</p>
</div>
</div>
</div>
<!--Start item-->
...
<div class="content">
<h3>ENKEL POW & <span>GEEN POS</span></h3>
<p>De munt is berekend enkel voor POW mining en zal nooit veranderen naar POS</p>
</div>
</div>
</div>
</div>
...
<div class="row">
<div class="col-md-12">
<p>© 2017 BitcoinZ Community. Alle rechten voorbehouden</p>
