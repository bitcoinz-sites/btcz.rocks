<?php $t = require __DIR__ . '/../translations/tr.php'; ?>
<!DOCTYPE html>
...
<header id="top-nav" class="top-nav page-header">
    <div class="container"><a href="/" class="logo smooth-scroll"><img src="/img/logo.png" alt="logo" class="logo-white"><img src="/img/logo.png" alt="logo" class="logo-dark"></a>
        <nav class="top-menu">
            <ul class="sf-menu">
                <!--Menu default-->
                <li><a href="<?php echo $t['community-paper-link']; ?>" target="_blank"><?php echo $t['Community Paper']; ?></a></li>
                ...
                <li><a href="#" class="smooth-scroll">Havuzlar</a></li>
                <ul>
                    <?php
        ...
        <div data-image="/img/bgn22.jpg" class="slide bg-mask background-image full-vh">
            <div class="container-slide vertical-align center head-desc">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="heading-title-big"><br>YENİ PARANIZ<br><span>BITCOINZ: GERÇEK BITCOIN 2.0</span></div>
                            <div class="description-slide">Merkezsiz paraya hoşgeldiniz!</div>
                            <div class="buttons-section"><a href="<?php echo $t['community-paper-link']; ?>" target="_blank" class="btn dark-btn large-btn"><?php echo $t['Community Paper']; ?></a><a
                                        href="https://youtu.be/RI-V7n8amFk" target="_blank" class="btn dark-btn large-btn">KAZMAYA BAŞLA</a><a href="https://info.btcz.rocks/" class="btn dark-btn large-btn" target="_blank">SON HABERLER</a><a href="https://btcz.fund/" class="btn dark-btn large-btn" target="_blank">BAĞIŞ</a><br><br>
                                <center>
                ...
                <div class="item-about">
                    ...
                    <div class="content">
                        ...
                        <p>
                            ...
                            - BitcoinZ üzerindeki tüm işlemler herkese açıktır.<br>
                            - İşlem yapan kişiler tamamen anonim kalır ( zk-SNARK ).<br>
                            - Merkezi olmayan GPU madenciliği ( ASIC ile kazım yapılamamaktadır. )<br>
            ...
            <div class="tabs services-tabs">
                <ul class="services-carousel">
                    ...
                    <li class="animated-service anim-shadow"><a href="#tabs-4"><i class="pe-7s-map"></i>
                            <h4>Dolaşımlı Arz</h4>
                            <p>2.5 dakikada bir 12500 BTCZ</p></a></li>
                </ul>
                ...
                <div id="tabs-2">
                    <div class="col-md-6">
                        <div class="head-service small-head text-left">
                            ...
                            <p>M-cüzdanlar gibi hassas veri programları, ücretsiz açık kaynak kodunu ve diğer takımlar / bölmeler tarafından cüzdanlarını inceleyebilmek için bültenlerine sha256
                                sağlamalıdır. Diğer ekip tarafından gözden geçirilmemiş herhangi bir cüzdan kullanılmamalıdır.
                            </p>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="item-about item-choose">
                    ...
                    <div class="content">
                        <h3>BITCOINZ, <span>GERÇEK BITCOIN 2.0'dir</span></h3>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <ul class="footer-menu">
                        ...
                        <li><a href="https://bitcointalk.org/index.php?topic=2166510.0" class="smooth-scroll" target="_blank">BITCOINTALK KONUSU</a></li>
                    </ul>
                </div>
            </div>
        </div>
